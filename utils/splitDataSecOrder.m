function [trainLen, valLen, testLen, trainX, valX, testX, trainY, valY, testY] = splitDataSecOrder(inputSignal,outputSignal,H)
%Split data into train, val, test
Xhat = ensembleSecOrder(inputSignal, H); % Only different with function splitData, use second order ensemble
